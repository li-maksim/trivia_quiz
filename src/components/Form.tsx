    ...
    <form action="POST" onSubmit={(e) => handleSubmit(e)}>
      <div className="flex flex-col gap-5">
        ...
        <Input
          type="radio"
          id="c"
          questionText={answers.answer_c}
          checked={values.c}
          fn={changeValues}
          highlight={highlights.c}
        />
        <Input
          type="radio"
          id="d"
          questionText={answers.answer_d}
          checked={values.d}
          fn={changeValues}
      ...
      {submittedEmpty ? (
        <div className="text-[var(--color-red)]">Please choose an option</div>
      ) : null}
